...
namespace PrismApp.Views
{
    public partial class AnimationPage : ContentPage
    {
        ...
        private async void BooshButton_Clicked(object sender, System.EventArgs e)
        {
            await Task.WhenAll(new[] {
                // Start async data access here?
                LayoutRoot.ScaleTo(2, 1000, Easing.CubicOut),
            ...
            await Task.WhenAll(new[] {
                LayoutRoot.ScaleTo(1, 1000, Easing.CubicIn),
                LayoutRoot.FadeTo(1, 1000, Easing.CubicIn)
            });
